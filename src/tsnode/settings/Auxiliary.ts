...
//A BusDevice has acces to the Bus
    export abstract class BusDevice {
        broker:Broker;
        private id:number;
        static cnt:number = 0;
     ...
     */
    export class AuxiliaryMapBroker {
        topics : Topic[];
     ...
     */
    export class AuxiliaryBusDeviceArray {
     ...
     */
    export class DBRequestMessage extends Message {
     ...
     */
    export class DBSettingsRequest extends DBRequest {
     ...
     */
    export class AuxiliarySettingsMessage extends Message {
